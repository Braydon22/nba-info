...
const avgUrl = 'https://www.balldontlie.io/api/v1/season_averages?player_ids[]='
    ...
    return (
        <div className="single-player-container">
            ...
            <div className="div-center">
                ...
                <h3>Height: {player.height_feet}-Foot-{player.height_inches}</h3>
            ...
            {playerAvg
                ? <div className="player-average-container">
                    <div className='div-center' style={{ marginBottom: "50px" }}>
                        <h2>Season {year - 1} - {year} Averages</h2>
                    </div>
            ...
            <div className="background-text" style={{ color: player.team_conference === 'East' ? "#3246abba" : "#ab323249" }}>
